let
  logo = builtins.fetchurl {
    url = "https://github.com/mbprtpmix/nixos-black-theme/raw/master/nixos-logo-white-hires.png";
    sha256 = "1c90r0s683myz3s9v6g8jb78bcij3sqg06ilk21dcrmi08l71rzq";
  };
in
''
/* GTK UI CSS */
